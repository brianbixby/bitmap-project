...
const readFileHelper = module.exports = (filePath, rfCallback) => {
  if(filePath.substr(filePath.length - 4) !== '.bmp') throw new Error(`${filePath} is not a bmp file. Please visit https://online-converting.com/image/convert2bmp/ to convert this image to a bmp file.`);
